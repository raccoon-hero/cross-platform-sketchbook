namespace KPCore5
{
    public class KPCore5
    {
        #region Lab1Instructions
        public static void Lab1StartProcess(string inputPath, string outputPath)
        {
        ...
        public static void Lab2StartProcess(string inputPath, string outputPath)
        {
        ...
        public static void Lab3StartProcess(string inputPath, string outputPath)
        {
